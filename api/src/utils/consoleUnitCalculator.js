class ConsoleUnitCalculator {
    ...
    static async calculateConsoleUnitPrice(measurements, materials, prices) {
        try {
            ...
            throw new Error(`Console unit price calculation failed: ${error.message}`);
        }
    }
}

module.exports = ConsoleUnitCalculator;